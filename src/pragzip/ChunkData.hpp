...
/*
m pragzip && src/tools/pragzip -P 0 --count-lines 4GiB-base64.gz
...
/usr/bin/time -v src/tools/pragzip -P 0 --count-lines 4GiB-base64.gz
    ...
    public ChunkData
{
    ...
    [[nodiscard]] bool
    containsMarkers() const noexcept override
    {
        return m_containsMarkers;
    }

    void
    applyWindow( WindowView const& window ) override
    {
